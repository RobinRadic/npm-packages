...
export interface StylusLoaderOptions extends RenderOptions, LoaderOptions {}
...
export type ExposeLoaderOptions = string | { name: string, as?: string, test?: RegExp }
...
export type FileLoaderBuildResourcePathFn = (url: string, resourcePath: string, context: string) => string;
