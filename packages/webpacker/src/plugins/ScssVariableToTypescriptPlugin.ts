...
export namespace ScssVariableToTypescriptPlugin {
...
export class ScssVariableToTypescriptPlugin {
    constructor(protected options: ScssVariableToTypescriptPlugin.Options) {
        this.options = {
    ...
    getVariables(content: string): ScssVariableToTypescriptPlugin.Variables {
        let variables: ScssVariableToTypescriptPlugin.Variables = { scss: [], camel: [], css: [], dot: [] };
    ...
    format(variables: ScssVariableToTypescriptPlugin.Variables, tab: string | number = 4) {
