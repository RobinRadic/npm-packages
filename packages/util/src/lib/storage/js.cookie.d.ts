...
export interface CookiesStatic {
     ...
     */
    withConverter(converter: CookieConverter | {
        write: CookieConverter;
        read: CookieConverter;
    }): CookiesStatic;
}
export declare type CookieConverter = (value: string, name: string) => string;
declare let cookie: CookiesStatic;
