...
export declare class AuthMethod extends StringType {
    ...
    static getKeyName(method: AuthMethod | string): "password" | "key" | "token" | "user" | "secret" | "id" | "keyfile";
    static getSecretName(method: AuthMethod | string): "password" | "key" | "token" | "user" | "secret" | "id" | "keyfile";
