...
export declare class Output {
    ...
    sparkly(numbers: Array<number | ''>, options?: SparklyOptions, ret?: boolean): string | this;
    highlight(code: string, options?: HighlightOptions, ret?: boolean): string | this;
